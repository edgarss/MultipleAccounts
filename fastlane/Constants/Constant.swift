...
enum Constant {
    ...
    static let userName = "edgars@nimblehq.co"
    ...
    static let stagingBundleId = "com.nimble.multipleacc.staging"
    static let productionBundleId = "com.nimble.multipleacc"
    static let projectName = "MultipleAccounts"
